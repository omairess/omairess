...
# plausible setting, which is what DANCE_RMFANOVA_DEFAULT is chosen from.
#
...
def <- res[res$method %in% DANCE_RMFANOVA_DEFAULT, ]
bad <- res[res$method %in% DANCE_RMFANOVA_INFLATED, ]
stopifnot(
