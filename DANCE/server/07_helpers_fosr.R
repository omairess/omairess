...
dance_fit_fosr_ols <- function(Y, df_reg, predictors,
  ...
  # this case (dance_r_squared returns NA when SST is at the noise floor); the
  ...
  list(beta.hat = coefs, fitted.values = fitted_vals, resid = residuals,
       ...
       # dance_fosr_design() below is the one place that turns new data into a
...
# ==========================================================================
dance_fosr_design <- function(fit, newdata) {
